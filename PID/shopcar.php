...
$sql = <<<qlcq
	select p.p_name,d_quantity,p.p_price,d_id,(d_quantity*p.p_price) as total_price from dreamlist d inner join product p on d.p_id=p.p_id where (buy=false && m_id=$fin);
	qlcq;
